...
const uri = 'mongodb+srv://NancyServer:server123@cluster7.pmcovae.mongodb.net/?retryWrites=true&w=majority'
const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });

client.connect((err) => {
	const orders = client.db('smartDhopa').collection('order');
